    ...
    constructor(props) {
      ...
      this.state = {
        ...
        navLinks : [
          ...
          { id: 2, title: "Tutorials", link: "/page-tutorials-sidebar"},
          { id: 3, title: "Portfolio", link: "/page-portfolio"},
          { id: 4, title: "Members", link: "/page-auth"},
          ]
        };
                                              ...
                                              childArray.nestedChild.map((nestedChildArray, nestedKey) =>
                                                ...
                                                <li key={nestedKey}>
                                                  <Link to={nestedChildArray.link}>
                                                    {nestedChildArray.title}{" "}{nestedChildArray.isNewPage ? <span className="badge badge-primary rounded">NEW</span> : null}
                                                  </Link>
                                                </li>
                                              )
                                            }
                                          </ul>
                                        </li> : <li key={childKey}><Link to={childArray.link}>{childArray.title}</Link></li>
                                      )
                                    }
                                </ul>
                              }
