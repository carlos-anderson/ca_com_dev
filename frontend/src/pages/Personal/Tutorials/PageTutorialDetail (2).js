...
import { Container, Button, Row, Col, Alert, Form, FormGroup, Label, Input, Card, CardBody, CardImg } from 'reactstrap';
...
class PageTutorialDetail extends Component {
  ...
  componentDidMount() {
    ...
    return {
      post: state.postsData.find(post => post.postId === id)
    };*/}
  }
                    ...
                    <Container>
                      <Row className="justify-content-center">
                        <Col lg="7" className="text-center">
                          <h1 className="title">Temp Title</h1>
                        </Col>
                      </Row>
                    </Container>
                  </section>
                  ...
                  <Container>
                    ...
                    <Row>
                      <Col lg="8" md="6">
                          ...
                          <Card className="shadow rounded border-0 mt-4">
                            <CardBody>
                              <Col xs="12" className="text-center">
                                <h5 className="card-title mb-0">Want to leave a comment?</h5>
                                <Link to="/page-auth" className="text-dark font-weight-bold">
                        ...
                        {context.token && <React.Fragment> <Card className="shadow rounded border-0 mt-4">
                          <CardBody>
                            ...
                            <Form onSubmit={this.handleCommentSubmit} className="mt-3">
                              <Row>
                                <Col md="12">
                                ...
                                <Col md="12">
                                  ...
                                  <div className="mb-0 mt-3">
                                    <Link to="/page-tutorial-detail" onClick={context.logout} className="text-dark font-weight-bold">Logout</Link>
                                  </div>
                                </Col>
                                ...
                                this.state.blogs.map((blog, key) =>
                                  <Col lg="6" className="mt-4 pt-2" key={blog.id} name="blog">
                                    <Card className="blog rounded border-0 shadow">
                                      ...
                                      <CardBody className="content">
                                        <h5>
                                          <Link to="/page-tutorial-detail" className="card-title title text-dark">
                                            {blog.title}
                                          </Link>
                                        </h5>
                                        <div className="post-meta d-flex justify-content-between mt-3">
                                          ...
                                          <Link to="/page-tutorial-detail" className="text-muted readmore">
