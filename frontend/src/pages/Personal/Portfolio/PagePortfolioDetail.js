            ...
            return (
                <React.Fragment>
                    ...
                    <section className="section">
                        ...
                        <React.Fragment>
                          {!context.token && <Card className="shadow rounded border-0 mt-4">
                            <CardBody>
                              <Col xs="12" className="text-center">
                                <h5 className="card-title mb-0">Want to leave a comment?</h5>
                                <Link to="/page-signup" className="text-dark font-weight-bold">
                          ...
                          <Row>
                            <Col xs="12" className="text-center">
                              <h5 className="card-title mb-0">Want to leave a comment?</h5>
                                <Link to="/page-login" className="text-dark font-weight-bold">
