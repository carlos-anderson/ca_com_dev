                        ...
                        <Row className="align-items-center">
                            <Col sm="6">
                                <div className="text-sm-left">
                                    <p className="mb-0">© 2020 Developed by <a href="http://carlos-anderson.com/" target="_blank"  rel="noopener noreferrer"  className="text-success">Carlos Anderson</a>.</p>
                                </div>
                            </Col>

                            <Col sm="6" className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                <ul className="list-unstyled social-icon social text-sm-right mb-0">
                                    <li className="list-inline-item mb-0"><h4 className="inline-title">Follow Me </h4></li>
